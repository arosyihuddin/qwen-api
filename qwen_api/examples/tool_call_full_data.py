...
from qwen_api.core.types.response.function_tool import FunctionToolParam, FunctionDetail
...
def main():
    ...
    try:
        response_stream = client.chat.create(
            messages=messages,
        ...
        for chunk in response_stream:
            # print(chunk)
            # Some iterator implementations might yield raw tuples; guard against that.
            try:
