...
This script demonstrates how to use the Qwen API with streaming enabled for basic chat
...
def main():
    """
    Main function that demonstrates basic synchronous streaming chat usage.

    1. Creates a Qwen client instance
    2. Constructs a simple chat message
    3. Sends the request to the Qwen API with streaming enabled
    ...
    try:
        ...
        print("Sending streaming request to Qwen API...")
